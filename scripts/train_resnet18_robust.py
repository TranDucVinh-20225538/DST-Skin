...
def train_resnet18_robust():
    ...
    print(f"Training ResNet-18 CE-Robust on {device}.")
    ...
    best_val_auc = 0.0
    best_path = "data/models/resnet18_robust_best.pth"
    ...
    final_path = "data/models/resnet18_robust_epoch_last.pth"
    torch.save(model.state_dict(), final_path)
    print(f"Saved final model to {final_path}.")


if __name__ == "__main__":
    train_resnet18_robust()
