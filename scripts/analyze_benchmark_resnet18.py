...
FEATURE_FILE = "outputs/features/resnet18_isic_pad_features.pt"
SEED = 42
...
def main():
    ...
    # =========================
    print("\n=== Score comparison (ResNet-18, OODScorer + ViM/ReAct) ===")
    ...
    df_scores.to_csv("outputs/reports/resnet18_score_comparison.csv", index=False)
    ...
    df_disp.to_csv(
        "outputs/reports/resnet18_dispersion_vs_separability.csv", index=False
    )
    print("\n=== Dispersion vs separability (ResNet-18) ===")
    ...
    df_ablation.to_csv("outputs/reports/resnet18_mahalanobis_ablation_N.csv", index=False)
    ...
    df_rc.to_csv("outputs/reports/resnet18_risk_coverage_mahalanobis.csv", index=False)
    ...
    df_rc_summary.to_csv(
        "outputs/reports/resnet18_risk_coverage_summary.csv", index=False
    )
    ...
    print("\n✅ Saved files:")
    print(" - outputs/reports/resnet18_score_comparison.csv")
    print(" - outputs/reports/resnet18_dispersion_vs_separability.csv")
    print(" - outputs/reports/resnet18_mahalanobis_ablation_N.csv")
    print(" - outputs/reports/resnet18_risk_coverage_mahalanobis.csv")
    print(" - outputs/reports/resnet18_risk_coverage_summary.csv")
